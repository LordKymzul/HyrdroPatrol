...
export default function DashMidnightLineChart({ datamidnight }: {
    datamidnight: TDataMidnight[]
}) {
    return (
        <ResponsiveContainer width={'100%'} height={300}>
            <AreaChart data={datamidnight}
                ...
                <Tooltip />
                <Area type="monotone" dataKey="mean_tp_midnight" stroke="#ADD8E6" fillOpacity={1} fill="url(#colorUv)" />
                <Area type="monotone" dataKey="mean_azp_midnight" stroke="#D8BFD8" fillOpacity={1} fill="url(#colorPv)" />
